...
**Valdcoin Core's `configure` script by default will ignore the depends output.** In
...
options will be passed to valdcoin's configure. In this case, `--disable-wallet`.

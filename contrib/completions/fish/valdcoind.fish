...
complete --command valdcoind --no-files

# Extract options
function __fish_valdcoind_get_options
...
complete \
    --command valdcoind \
    --arguments "(__fish_valdcoind_get_options --nofiles)"

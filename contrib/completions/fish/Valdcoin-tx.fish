...
# Extract options
function __fish_valdcoin_tx_get_options
...
# Extract commands
function __fish_valdcoin_tx_get_commands
...
complete \
    --command valdcoin-tx \
    --condition "not __fish_valdcoin_seen_cmd (__fish_valdcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_valdcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command valdcoin-tx \
    --arguments "(__fish_valdcoin_tx_get_commands)" \
    --no-files

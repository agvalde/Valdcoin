...
complete --command valdcoin-qt --no-files

# Extract options
function __fish_valdcoinqt_get_options
...
complete \
    --command valdcoin-qt \
    --arguments "(__fish_valdcoinqt_get_options --nofiles)"

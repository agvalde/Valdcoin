...
"""Example logging Valdcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/valdcoind
...
def main(valdcoind_path):
    ...
    # to the tracepoints
    valdcoind_with_usdts.enable_probe(
        probe="flush", fn_name="trace_flush")
    b = BPF(text=program, usdt_contexts=[valdcoind_with_usdts])

...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef VALDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define VALDCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the valdcoin network\n')
    ...
    g.write('#endif // VALDCOIN_CHAINPARAMSSEEDS_H\n')

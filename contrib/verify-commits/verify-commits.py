...
def tree_sha512sum(commit='HEAD'):
    ...
    This is copied from github-merge.py. See https://github.com/valdcoin-core/valdcoin-maintainer-tools."""
...
def main():
    ...
    while True:
        ...
        os.environ['VALDCOIN_VERIFY_COMMITS_ALLOW_SHA1'] = "0" if no_sha1 else "1"

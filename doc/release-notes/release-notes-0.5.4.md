Valdcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/valdcoin/files/Valdcoin/valdcoin-0.5.4/
...
http://gitorious.org/valdcoin/valdcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Valdcoin-Qt notifications under Growl 1.3.
Increase required age of Valdcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxValdcoin properly when installing Valdcoin-Qt over it. (Windows)

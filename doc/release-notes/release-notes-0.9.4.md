Valdcoin Core version 0.9.4 is now available from:

  https://valdcoin.org/bin/0.9.4/
...
this update is incompatible with the Valdcoin system and could lead to consensus
forks.

Valdcoin Core released binaries from https://valdcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~valdcoin/+archive/ubuntu/valdcoin
- A third-party or self-compiled Valdcoin Core

upgrade to Valdcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

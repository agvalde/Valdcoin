Valdcoin Core version 0.13.2 is now available from:

  <https://valdcoin.org/bin/valdcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update valdcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow valdcoin-tx to create v2 transactions (vlddrak)

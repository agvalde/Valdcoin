Valdcoin Core version 0.16.1 is now available from:

  <https://valdcoincore.org/bin/valdcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting valdcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure valdcoind processes are cleaned up when tests end (sdaftuar)

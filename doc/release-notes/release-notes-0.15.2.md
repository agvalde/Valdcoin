Valdcoin Core version *0.15.2* is now available from:

  <https://valdcoincore.org/bin/valdcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in valdcoin-tx (TheBlueMatt)

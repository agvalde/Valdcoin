Valdcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/valdcoin/files/Valdcoin/valdcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Valdcoin
...
New/changed settings (command-line or valdcoin.conf file)
--------------------------------------------------------

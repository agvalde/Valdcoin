...
Valdcoin Core version 0.19.1 is now available from:

  <https://valdcoincore.org/bin/valdcoin-core-0.19.1/>
...
From Valdcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Valdcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Valdcoin Core does not yet change appearance when
...
- #17488 fix "valdcoind already running" warnings on macOS (fanquake)

Download URL: https://sourceforge.net/projects/valdcoin/files/Valdcoin/valdcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 VLD fee schedule (users still pay 0.01 VLD per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #valdcoin00 - #valdcoin99

Valdcoin Core version 0.10.4 is now available from:

  <https://valdcoin.org/bin/valdcoin-core-0.10.4/>
...
- #6953 `43c2789` Split valdcoin-tx into its own package
- #6953 `dfe0d4d` Include valdcoin-tx binary on Debian/Ubuntu

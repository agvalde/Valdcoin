Valdcoin Core version 0.9.2.1 is now available from:

  https://valdcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 VLD to 0.01 VLD
...
- Fix "Start valdcoin on system login"

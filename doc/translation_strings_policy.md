...
This document provides guidelines for internationalization of the Valdcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `valdcoin_en.ts` remains unchanged.

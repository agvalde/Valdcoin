...
# Copyright 2016-2017 The Valdcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test framework for valdcoin utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "valdcoin-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, valdcoin-tx

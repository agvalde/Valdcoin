#!/usr/bin/env python3
# Copyright (c) 2014-2019 The Valdcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test running valdcoind with the -rpcbind and -rpcallowip options."""
...
class RPCBindTest(ValdcoinTestFramework):

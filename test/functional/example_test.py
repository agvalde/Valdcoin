...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ValdcoinTestFramework
    pass


class ExampleTest(ValdcoinTestFramework):
    # Each functional test is a subclass of the ValdcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        ValdcoinTestFramework class so other tests can use it."""

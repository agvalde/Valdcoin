...
class DustRelayFeeTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        for dustfee_sat_kvb in (DUST_RELAY_TX_FEE, 0, 1, 66, 500, 1337, 12345, 21212, 333333):
            ...
            for output_script, description in output_scripts:
                self.test_dust_output(self.nodes[0], dustfee_vld_kvb, output_script, description)

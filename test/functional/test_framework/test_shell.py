...
class TestShell:
    """Wrapper Class for ValdcoinTestFramework.

    The TestShell class extends the ValdcoinTestFramework
    ...
    class __TestShell(ValdcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ValdcoinTestFramework child class.
            self.num_nodes = 1

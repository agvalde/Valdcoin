...
class SegWitTest(ValdcoinTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older valdcoind's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let valdcoind fill it in.

...
class TxnMallTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 VLD:
        ...
        # First: use raw transaction API to send 1240 VLD to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VLD coin each
        ...
        # Node0's balance should be starting balance, plus 50VLD for another
        ...
        # Node0's total balance should be starting balance, plus 100VLD for

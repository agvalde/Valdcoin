...
By default, valdcoind will dump mempool on shutdown and
...
class MempoolPersistTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent valdcoind from writing mempool.dat to disk. Verify that `savemempool` fails")

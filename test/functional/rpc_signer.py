...
Verify that a valdcoind node can use an external signer command.
...
class RPCSignerTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart valdcoind with -signer=<cmd>',

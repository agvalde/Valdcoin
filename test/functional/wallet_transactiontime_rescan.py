...
class TransactionTimeRescanTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine VLD and create transactions
        ...
        # generate some vld to create transactions and check blockcount
        ...
        # send 10 vld to user's first watch-only address
        self.log.info('Send 10 vld to user')
        ...
        # send 5 vld to our second watch-only address
        self.log.info('Send 5 vld to user')
        ...
        # send 1 vld to our third watch-only address
        self.log.info('Send 1 vld to user')

#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Valdcoin Core developers
...
class InvalidMessagesTest(ValdcoinTestFramework):
    ...
    def test_addrv2(self, label, required_log_messages, raw_addrv2):
        ...
        # Make sure valdcoind signals support for ADDRv2, otherwise this test

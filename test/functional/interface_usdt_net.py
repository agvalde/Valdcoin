...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/valdcoin/valdcoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our valdcoind node")

...
"""
Test starting valdcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that valdcoind has bound on "::1" (for RPC) and "::" (for P2P).

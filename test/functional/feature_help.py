#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Valdcoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Verify that starting valdcoin with -h works as expected."""

from test_framework.test_framework import ValdcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start valdcoin with -h for help text")
        ...
        self.log.info("Start valdcoin with -version for version information")
        ...
        self.log.info("Start valdcoind with -fakearg to make sure it does not start")

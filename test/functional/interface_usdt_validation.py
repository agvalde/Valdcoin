...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/valdcoin/valdcoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(ValdcoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/valdcoin/valdcoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected

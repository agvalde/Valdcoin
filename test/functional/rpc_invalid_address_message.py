...
class InvalidAddressErrorMessageTest(ValdcoinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given valdcoin address.", node.validateaddress)

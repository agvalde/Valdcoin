...
#ifndef VALDCOIN_ARITH_UINT256_H
#define VALDCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Valdcoin only uses this "compact" format for encoding difficulty
...
#endif // VALDCOIN_ARITH_UINT256_H

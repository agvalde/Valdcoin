...
#ifndef VALDCOIN_UTIL_SYSCALL_SANDBOX_H
#define VALDCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during valdcoind initialization if Valdcoin Core was compiled
...
#endif // VALDCOIN_UTIL_SYSCALL_SANDBOX_H

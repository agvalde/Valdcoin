 ...
 */
#ifndef VALDCOIN_UTIL_SYSTEM_H
#define VALDCOIN_UTIL_SYSTEM_H
...
extern const char * const VALDCOIN_CONF_FILENAME;
extern const char * const VALDCOIN_SETTINGS_FILENAME;

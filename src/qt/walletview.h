...
#ifndef VALDCOIN_QT_WALLETVIEW_H
#define VALDCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a valdcoin wallet, and offers access to
...
#endif // VALDCOIN_QT_WALLETVIEW_H

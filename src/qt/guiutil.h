...
#ifndef VALDCOIN_QT_GUIUTIL_H
#define VALDCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Valdcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "valdcoin:" URI into recipient object, return true on successful parsing

...
#ifndef VALDCOIN_QT_RECEIVECOINSDIALOG_H
#define VALDCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of valdcoins */
...
#endif // VALDCOIN_QT_RECEIVECOINSDIALOG_H

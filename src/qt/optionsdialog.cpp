      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->valdcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->valdcoinAtStartup);
    ...
    ui->valdcoinAtStartup->setToolTip(ui->valdcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->valdcoinAtStartup->setText(ui->valdcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openValdcoinConfButton->setToolTip(ui->openValdcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ValdcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->valdcoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSVLDontrols);
...
void OptionsDialog::on_openValdcoinConfButton_clicked()
{

...
//! Entry point for ValdcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &ValdcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for ValdcoinGUI tests.
void AppTests::guiTests(ValdcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &ValdcoinGUI::consoleShown, this, &AppTests::consoleTests);

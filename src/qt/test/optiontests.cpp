...
{
    // Test regression https://github.com/valdcoin/valdcoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/valdcoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/valdcoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Valdcoin/Valdcoin-Qt.conf and all else left as default,
    // valdcoin-qt should set both -listen and -listenonion to false and start successfully.

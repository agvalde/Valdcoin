...
#ifndef VALDCOIN_COMPAT_ASSUMPTIONS_H
#define VALDCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Valdcoin cannot be compiled without assertions."
#endif
...
#endif // VALDCOIN_COMPAT_ASSUMPTIONS_H

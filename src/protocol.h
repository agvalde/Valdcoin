...
#ifndef VALDCOIN_PROTOCOL_H
#define VALDCOIN_PROTOCOL_H
...
/**
 * Valdcoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Valdcoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // Valdcoin Core nodes used to support this by default, without advertising this bit,
    ...
    // valdcoin-development mailing list. Remember that service bits are just

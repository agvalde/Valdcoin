...
#ifndef VALDCOIN_SCRIPT_STANDARD_H
#define VALDCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a valdcoin address
 */
...
/**
 * Generate a Valdcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // VALDCOIN_SCRIPT_STANDARD_H

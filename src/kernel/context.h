...
#ifndef VALDCOIN_KERNEL_CONTEXT_H
#define VALDCOIN_KERNEL_CONTEXT_H

#include <memory>

namespace kernel {
//! Context struct holding the kernel library's logically global state, and
//! passed to external libvaldcoin_kernel functions which need access to this
...
#endif // VALDCOIN_KERNEL_CONTEXT_H

...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{"scanblocks",
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (valdcoin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
    ...
    const fs::path& temppath)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/valdcoin/valdcoin/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);

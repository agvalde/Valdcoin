...
#ifndef VALDCOIN_NODE_CONNECTION_TYPES_H
#define VALDCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/valdcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Valdcoin’s Peer-to-Peer Network")
...
#endif // VALDCOIN_NODE_CONNECTION_TYPES_H

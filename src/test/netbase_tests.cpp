...
{
    BOOST_CHECK(TestSplitHost("www.valdcoincore.org", "www.valdcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.valdcoincore.org]", "www.valdcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.valdcoincore.org:80", "www.valdcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.valdcoincore.org]:80", "www.valdcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("::7333", "::7333", 0));
    BOOST_CHECK(TestSplitHost(":7333", "", 7333));
    BOOST_CHECK(TestSplitHost("[]:7333", "", 7333));
    ...
    BOOST_CHECK(TestSplitHost("www.valdcoincore.org:65536", "www.valdcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.valdcoincore.org:0", "www.valdcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.valdcoincore.org:", "www.valdcoincore.org:", 0, false));
}

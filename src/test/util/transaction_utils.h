// Copyright (c) 2019-2020 The Valdcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VALDCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define VALDCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // VALDCOIN_TEST_UTIL_TRANSACTION_UTILS_H

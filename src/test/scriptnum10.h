...
#ifndef VALDCOIN_TEST_SCRIPTNUM10_H
#define VALDCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Valdcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VALDCOIN_TEST_SCRIPTNUM10_H

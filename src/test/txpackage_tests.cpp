...
BOOST_FIXTURE_TEST_CASE(package_cpfp_tests, TestChain100Setup)
{
    ...
    // fee deltas. This should be taken into account. De-prioritise the parent transaction by -1VLD,
    ...
    // Package CPFP: Even though the parent pays 0 absolute fees, the child pays 1 VLD which is
    ...
    // Now that the child's fees have "increased" by 1 VLD, the cheap package should succeed.
    {
    ...
    // Parent pays 1 VLD and child pays none. The parent should be accepted without the child.
    {
        BOOST_CHECK_EQUAL(m_node.mempool->size(), expected_pool_size);

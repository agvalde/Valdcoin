// Copyright (c) 2012-2021 The Valdcoin Core developers
...
// amounts 1 .. 10000
#define NUM_MULTIPLES_1VLD 10000

// amounts 50 .. 21000000
#define NUM_MULTIPLES_50VLD 420000
...
BOOST_AUTO_TEST_CASE(compress_amounts)
{
    ...
    for (uint64_t i = 1; i <= NUM_MULTIPLES_1VLD; i++)
        BOOST_CHECK(TestEncode(i * COIN));

    for (uint64_t i = 1; i <= NUM_MULTIPLES_50VLD; i++)

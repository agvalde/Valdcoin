...
#ifndef VALDCOIN_INTERFACES_NODE_H
#define VALDCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a valdcoin node (valdcoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or valdcoin.conf.
...
#endif // VALDCOIN_INTERFACES_NODE_H

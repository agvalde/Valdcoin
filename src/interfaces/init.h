...
#ifndef VALDCOIN_INTERFACES_INIT_H
#define VALDCOIN_INTERFACES_INIT_H
...
//! (valdcoin-gui, valdcoin-node, valdcoin-wallet, valdcoind, valdcoin-qt) and each
...
#endif // VALDCOIN_INTERFACES_INIT_H

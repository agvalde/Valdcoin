...
// Copyright 2015 Valdcoin Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef VALDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
#define VALDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // VALDCOIN_UNIVALUE_INCLUDE_UNIVALUE_H

...
#ifndef VALDCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define VALDCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Valdcoin Core wallet was originally a collection of unrelated private
...
#endif // VALDCOIN_WALLET_SCRIPTPUBKEYMAN_H

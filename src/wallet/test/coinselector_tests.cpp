...
BOOST_AUTO_TEST_CASE(knapsack_solver_test)
{
    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
        ...
        BOOST_CHECK_EQUAL(result14->GetSelectedValue(), 1 * COIN);  // we should get 1 VLD in 1 coin
        ...
        BOOST_CHECK_EQUAL(result15->GetSelectedValue(), 2 * COIN);  // we should get 2 VLD in 1 coin
...
BOOST_AUTO_TEST_CASE(check_max_weight)
{
    ...
    {
        // Scenario 1:
        // The actor starts with 1x 50.0 VLD and 1515x 0.033 VLD (~100.0 VLD total) unspent outputs
        // Then tries to spend 49.5 VLD
        // The 50.0 VLD output should be selected, because the transaction would otherwise be too large
...

    {
        ...
        // The actor starts with 400x 0.0625 VLD and 2000x 0.025 VLD (75.0 VLD total) unspent outputs
        // Then tries to spend 49.5 VLD
...

    {
        ...
        // The actor starts with 1515x 0.033 VLD (49.995 VLD total) unspent outputs
...
BOOST_AUTO_TEST_CASE(SelectCoins_effective_value_test)
{
    ...
    CoinsResult available_coins;
    {
        ...
        add_coin(available_coins, *dummyWallet, 100000); // 0.001 VLD
    }

    CAmount target{99900}; // 0.000999 VLD

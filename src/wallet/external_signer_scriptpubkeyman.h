...
#ifndef VALDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define VALDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // VALDCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

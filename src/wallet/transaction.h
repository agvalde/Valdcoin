...
#ifndef VALDCOIN_WALLET_TRANSACTION_H
#define VALDCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this valdcoin node, and set to 0 for transactions that were created
...
#endif // VALDCOIN_WALLET_TRANSACTION_H

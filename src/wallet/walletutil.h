// Copyright (c) 2017-2021 The Valdcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VALDCOIN_WALLET_WALLETUTIL_H
#define VALDCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! valdcoin from opening the wallet, thinking it was newly created, and
...
#endif // VALDCOIN_WALLET_WALLETUTIL_H

Contributing to Valdcoin Core
============================

The Valdcoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Valdcoin Core
...
Before you start contributing, familiarize yourself with the Valdcoin Core build
system and tests. Refer to the documentation in the repository on how to build
Valdcoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/valdcoin/valdcoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/valdcoin/valdcoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Valdcoin Core PR Review Club](https://valdcoincore.reviews/) meeting.
...
Most communication about Valdcoin Core development happens on IRC, in the
`#valdcoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#valdcoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/valdcoin-core-dev/](https://www.erisian.com.au/valdcoin-core-dev/)
and [https://gnusha.org/valdcoin-core-dev/](https://gnusha.org/valdcoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/valdcoin-dev)
...
For GUI-related issues or pull requests, the https://github.com/valdcoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/valdcoin/valdcoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to valdcoin-qt
...
fork of Valdcoin Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/valdcoin/valdcoin/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/valdcoin/valdcoin  # Fetch the latest upstream commit
...
The following applies to code changes to the Valdcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Valdcoin
Network Protocol consensus changes.

Whether a pull request is merged into Valdcoin Core rests with the project merge
maintainers.
...
Patches that change Valdcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Valdcoin consensus, it must have been
...
https://github.com/valdcoin/valdcoin/pull/16189).

Also see the [backport.py script](
https://github.com/valdcoin-core/valdcoin-maintainer-tools#backport).
